...
const Threads = () => {
  ...
  return (
    <div className="tweet-container">
      {/* Render new tweet added from PostForm */}
      {/* Pass onPostTweet as a prop to PostForm */}
      {/* <PostForm onPostTweet={addNewTweet} />  */}
        ...
        <div key={index} className="tweets">
          ...
          <div className="tweet">
            ...
            <div className="intro-container">
              ...
              <p className="dot">.</p>
              <p className="date">
                {new Date(thread[0].tweetTime).toLocaleDateString("en-GB", {
                  day: "numeric",
                  month: "short",
                  year: "numeric",
                })}
          ...
          <div className="tweet">
            ...
            <div className="replying-container">
              <p className="replying-text">Replying to <span> @{thread[0].user.userId}</span></p> 
            </div>
            <div className="tweet-content">
              <p>{thread[0].textArea}</p>
            </div>
